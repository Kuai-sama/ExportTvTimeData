...
columns_To_Be_Deleted = ['last_seen', 'last_aired', 'next_aired', 'followed', 'archived', 'diffusion', 'folder',
                         'notification_type', 'is_web_serie', 'hashtag', 'number_of_seasons', 'favorite']
